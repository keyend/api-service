...
class Virtual
{
     ...
     * 给用户自动生成昵称
     *
     * @param integer $type 1生成昵称，2生成姓名
     * @return void
     */
    static public function nickname($type = 1)
    {
        ...
        $nicheng_wei=['嚓茶','皮皮虾','皮卡丘','马里奥','小霸王','凉面','便当','毛豆','花生','可乐','灯泡','哈密瓜','野狼','背包','眼神','缘分','雪碧','人生','牛排',
            ...
            '大叔','小伙','数据线','太阳','树叶','芹菜','黄蜂','蜜粉','蜜蜂','信封','西装','外套','裙子','大象','猫咪','母鸡','路灯','蓝天','白云',
        ...
        switch ($type){
            ...
            case 2:
                ...
                if ($style === 0) {
                    ...
                    $nicheng = self::english_name();
                } else {
                    $nicheng = self::generateName();
                }
        }
    ...
    static private function english_name()
    {
    ...
    static private function getXingList(){
    ...
    static private function getMingList() {
    ...
    private static function generateName(){
        $arrXing = self::getXingList();
        $numbXing = count($arrXing);
        $arrMing = self::getMingList();
