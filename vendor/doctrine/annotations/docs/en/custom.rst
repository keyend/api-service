...
``Doctrine\Annotations\NamedArgumentConstructorAnnotation`` interface
...
Usage with the 
``Doctrine\Annotations\NamedArgumentConstructorAnnotation``
interface (v1.11, deprecated as of v1.12):
.. code-block:: php

    namespace MyCompany\Annotations;

    use Doctrine\Annotations\NamedArgumentConstructorAnnotation;
