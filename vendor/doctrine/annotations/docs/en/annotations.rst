...
To cache annotations, you can create a ``Doctrine\Annotations\PsrCachedReader``.
...
.. code-block:: php
    ...
    use Doctrine\Annotations\AnnotationReader;
    use Doctrine\Annotations\PsrCachedReader;
...
``Doctrine\Annotations\AnnotationRegistry``. There are three
