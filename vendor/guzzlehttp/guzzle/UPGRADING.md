...
- `Guzzle\Version` has been removed. The VERSION constant can be found
...
```php
\Guzzle\Version::$emitWarnings = true;
```
...
Change `\Guzzle\Service\Inspector::fromConfig` to `\Guzzle\Collection::fromConfig`
...
### Guzzle\Http\Plugin\LogPlugin and Guzzle\Log
